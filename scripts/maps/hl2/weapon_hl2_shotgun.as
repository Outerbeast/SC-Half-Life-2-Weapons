...
final class weapon_hl2_shotgun : CustomGunBase
{
	...
	bool PostShoot()
	{
		g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_WEAPON, "hl2/shotgun_" + ( blDoubleShot ? "dbl_" : "" ) + "fire2.ogg", 1.0f, ATTN_NORM, 0, 93 + Math.RandomLong( 0, 0x1f ) );
	...
	void InsertShell()
	{
		if( self.m_iClip < self.iMaxClip() )
		{
			...
			g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_ITEM, "hl2/shotgun_reload" + Math.RandomLong( 1, 3 ) + ".ogg", 1.0f, ATTN_NORM, 0, 85 + Math.RandomLong( 0, 0x1f ) );
	...
	void SecondaryAttack()
	{
		...
		Shoot( 12, m_pPlayer.GetAutoaimVector( AUTOAIM_5DEGREES ), Vector( 0.17365f, 0.04362f, 0.00f ), BULLET_PLAYER_BUCKSHOT, 2048.0f );
